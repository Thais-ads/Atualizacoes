...
function fazPost(url, body) {
    ...
    request.onload = function () {
        ...
        if (retornoStatus == 200) {
            location.href = './Projeto/dash.html'
        } else {
            alert('Email ou senha invalidos! tente novamente 400'+request.responseText)
            console.log(request)
...
function functioncadastrafuncionario() {
    ...
    let url = "https://apisinfte.azurewebsites.net/api/Auth/nova-conta"
